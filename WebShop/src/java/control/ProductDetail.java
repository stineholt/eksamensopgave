...
public class ProductDetail extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String selectedProduktID = request.getParameter("produktid");
            ...
            request.getSession().setAttribute("productdetails", produktDetals);
                ...
                RequestDispatcher rd = request.getRequestDispatcher("ProduktDetails.jsp");
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>WELCOME to ProductDetail at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
