                ...
                if (orderID == 0){
                    ...
                    //Ny order oprettelse//
                        ...
                        try{
                            ...
                            df.newOrder(username,orderDate);
                            int NewOrder = df.getOrderID(username);
                            session.setAttribute("orderid", NewOrder);
                            String orderidasString = Integer.toString(NewOrder);
                            df.placeProduktForPurchase(orderidasString, idProduktString);
                    ...
                    int idOrder = df.getOrderID(username);
                    String orderidasString = Integer.toString(idOrder);
                    df.placeProduktForPurchase(orderidasString, idProduktString);  // tilføjet produkt til produktorderliste i db
